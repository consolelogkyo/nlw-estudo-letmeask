...
export function Room() {
  ...
  async function handleSendQuestion(event: FormEvent) {
    ...
    await database.ref(`NewRoom/${roomId}/questions`).push(question);
  ...
  async function handleLikeQuestion(questionId: string, likeId: string | undefined) {
    if (likeId) {
      await database.ref(`NewRoom/${roomId}/questions/${questionId}/likes/${likeId}`).remove()
    }
    else {
      await database.ref(`NewRoom/${roomId}/questions/${questionId}/likes`).push({
        authorId: user?.id,
      })
    }
  }
